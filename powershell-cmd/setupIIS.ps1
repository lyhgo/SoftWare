...
#open firewall_port
New-NetFirewallRule -DisplayName "IIS TCP_in" -Direction Inbound -LocalPort 80 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "IIS UDP_out" -Direction Inbound -LocalPort 80 -Protocol UDP -Action Allow
New-NetFirewallRule -DisplayName "IIS TCP_in" -Direction Outbound -LocalPort 80 -Protocol TCP -Action Allow
New-NetFirewallRule -DisplayName "IIS UDP_out" -Direction Outbound -LocalPort 80 -Protocol UDP -Action Allow